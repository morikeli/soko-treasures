...
dashboard_urlpatterns = [
    ...
    path('store/<str:store_id>/orders/', views.CustomerOrdersView.as_view(), name='customer_orders'),
...
urlpatterns + dashboard_urlpatterns + dashboard_crud_urlpatterns
